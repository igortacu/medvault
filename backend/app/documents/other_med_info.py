"""GET /other-med-info — list a patient's other medical information.

Covers hospitalizations, discharge summaries, pregnancy records, allergies,
immunizations and referrals. Thin wrapper over the shared category-list helper
(app/documents/categories.py): RLS row-filtering + explicit caregiver_can 403
...
router = APIRouter(tags=["other-med-info"])
